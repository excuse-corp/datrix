export const CommonEn = {
  ...
  data_center_desc:
    'Datrix also offers a user-friendly data center management interface for efficient data maintenance.',
  ...
  edit_model_success: 'Edit model success',
  edit_model_failed: 'Edit model failed',
  ...
  home_title: 'Datrix AI Data Assistant',
  ...
  skills_enabled_success: 'Skill enabled',
  skills_disabled_success: 'Skill disabled',
  skills_toggle_failed: 'Failed to update skill status',
  skills_delete_confirm_title: 'Delete skill',
  skills_delete_confirm_desc: 'Delete "{{name}}"? This cannot be undone.',
  skills_delete_success: 'Skill deleted',
  skills_delete_failed: 'Failed to delete skill',
  skills_delete_official_disabled: 'Official built-in skills cannot be deleted',
