...
sidebar_position: 1
title: Prerequisites
summary: "What you need before running Datrix locally or with Docker"
read_when:
...
Everything you need before installing Datrix.
...
Datrix requires **Python 3.10+**. We recommend Python 3.11 for the best compatibility.
...
Starting from v0.7.0, Datrix uses [uv](https://docs.astral.sh/uv/) for environment and package management, providing faster and more stable dependency resolution.
