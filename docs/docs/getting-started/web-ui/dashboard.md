...
Create data visualizations and reports using natural language. Datrix converts your questions into SQL queries and renders the results as interactive charts.
...
2. Datrix generates the appropriate SQL query
...
- A database connected to Datrix (see [Data Sources](/docs/getting-started/concepts/data-sources))
...
Datrix's visualization engine ([GPT-Vis](https://github.com/eosphoros-ai/GPT-Vis)) supports:
...
Datrix includes sample data for testing:
