...
summary: "What is available in the Datrix Web UI and where each main feature lives"
read_when:
  - You already started Datrix and want to know what to click first
  - You want a quick map of chat, knowledge, dashboard, and app screens
---

# Web UI Overview

Datrix ships with a web interface at **[http://localhost:5670](http://localhost:5670)**.
...
- [App Management](/docs/getting-started/web-ui/app-management) — create and manage Datrix applications
...
After starting the Datrix server, the Web UI is available at:
