...
Datrix provides multiple chat modes through its Web UI — each tailored for a different use case.
...
Query your connected databases using natural language. Datrix converts your question into SQL, executes it, and presents the results.
...
Datrix: [generates SQL, executes, and displays results in a table]
```
...
Datrix: [analyzes the file and presents results]
```
