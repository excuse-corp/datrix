...
**[dbgpts](https://github.com/eosphoros-ai/dbgpts)** is the official community repository of reusable components for Datrix — including apps, AWEL operators, workflow templates, and agents.
...
The `dbgpts` CLI is included when you install Datrix with the `dbgpts` extra:
