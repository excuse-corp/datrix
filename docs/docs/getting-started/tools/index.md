...
sidebar_position: 0
title: Tools & Plugins
summary: "How Datrix extends agents with MCP, dbgpts, and AWEL Flow"
read_when:
  - You want to add tools or external integrations to Datrix
  - You want to understand the difference between MCP, dbgpts, and AWEL Flow
---

# Tools & Plugins

Extend Datrix with external tools, community packages, and visual workflow building.
...
Datrix supports three main extension mechanisms:
...
Agents in Datrix can use tools to:
