...
Configure Datrix to use SiliconFlow's hosted model API. SiliconFlow provides access to multiple open-source models through a unified API, hosted in China.

## Prerequisites

- A [SiliconFlow API key](https://siliconflow.cn/)
- Datrix installed with `proxy_openai` extra
