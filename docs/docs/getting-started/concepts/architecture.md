...
sidebar_position: 0
title: Architecture
summary: "Datrix repo layout and ReAct-centered runtime architecture"
read_when:
  - You want the shortest mental model for how Datrix is organized
  - You need to understand how UI, API, agents, skills, tools, and data resources connect
---

# Architecture

Datrix is organized as a Python monorepo with a ReAct-centered agent runtime.
...
| `dbgpt-client` | Client SDK for Datrix APIs |
