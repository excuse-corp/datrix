...
## Install Datrix Application Database
<Tabs
  defaultValue="sqlite"
  values={[
...
You do not need to separately create the database tables related to the Datrix application in SQLite;
...
## Test data (optional)
The Datrix project has a part of test data built-in by default, which can be loaded into the local database for testing through the following command
- **Linux**
