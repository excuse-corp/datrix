# vLLM Inference
Datrix supports [vLLM](https://github.com/vllm-project/vllm) inference, a fast and easy-to-use LLM inference and service library.

## Install dependencies
`vLLM` is an optional dependency in Datrix. You can install it by adding the extra `--extra "vllm"` when installing dependencies.
