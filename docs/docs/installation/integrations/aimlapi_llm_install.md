...
### This section describes how to use the AI/ML API provider with Datrix.
...
3. Use the `configs/dbgpt-proxy-aimlapi.toml` configuration when starting Datrix.
...
### Or you can use docker/base/Dockerfile to run Datrix with AI/ML API:
