...
sidebar_position: 0
title: 架构
summary: "Datrix 仓库结构与以 ReAct 为中心的运行时架构"
read_when:
  - 你想快速理解 Datrix 在仓库中的组织方式
  - 你需要理解 UI、API、agent、skill、tool 和数据资源之间如何连接
---

# 架构

Datrix 是一个 Python 单体仓库（monorepo），其整体运行方式围绕以 ReAct 为中心的 agent runtime 展开。
...
| `dbgpt-client` | Datrix API 的客户端 SDK |
