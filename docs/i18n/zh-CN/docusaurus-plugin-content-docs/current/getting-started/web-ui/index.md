...
sidebar_position: 0
title: Web UI 总览
summary: "了解 Datrix Web UI 中有哪些主要能力，以及它们分别在哪里"
read_when:
  - 你已经启动了 Datrix，想知道先点哪里
  - 你想快速了解 chat、knowledge、dashboard 和 app 界面的分布
---

# Web UI 总览

Datrix 默认自带 Web 界面，地址为 **[http://localhost:5670](http://localhost:5670)**。
...
- [App Management](/docs/getting-started/web-ui/app-management) —— 创建和管理 Datrix 应用
...
启动 Datrix 服务后，可以通过以下地址访问 Web UI：
