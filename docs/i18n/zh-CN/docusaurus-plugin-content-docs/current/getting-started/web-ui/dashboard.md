...
使用自然语言创建数据可视化和报告。Datrix 会将你的问题转换为 SQL 查询，并将结果渲染为交互式图表。
...
- 已连接一个 Datrix 支持的数据库（参考 [Data Sources](/docs/getting-started/concepts/data-sources)）
...
Datrix 的可视化引擎（[GPT-Vis](https://github.com/eosphoros-ai/GPT-Vis)）支持以下图表：
