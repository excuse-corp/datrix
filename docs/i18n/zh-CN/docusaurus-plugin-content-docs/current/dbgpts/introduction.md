...
在 Datrix 中，skill 是一种可复用的能力包，为智能体提供完成某类任务的结构化方式。
...
在 Datrix 语境里，skill 不只是“模型知道什么”，而是一个打包好的工作流，帮助智能体决定：
...
按照 Datrix 当前 skill-creator 的实践，一个 skill 通常组织为一个小型、自包含的能力包：
