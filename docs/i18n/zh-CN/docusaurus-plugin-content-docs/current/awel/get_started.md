...
In Datrix, some basic dependent operators have already been encapsulated and can be referenced directly.
...
if __name__ == "__main__":
    if dag.leaf_nodes[0].dev_mode:
        ...
        # Production mode, Datrix will automatically load and execute the current file after startup.
        pass
```
