# MLX Inference
Datrix supports [MLX](https://github.com/ml-explore/mlx-lm) inference, a fast and easy-to-use LLM inference and service library.

## Install dependencies

`MLX` is an optional dependency in Datrix. You can install it by adding the extra `--extra "mlx"` when installing dependencies.
