...
In this example, we will show how to use the Elasticsearch as in Datrix RAG Storage. Using a Elasticsearch database to implement RAG can, to some extent, alleviate the uncertainty and interpretability issues brought about by Elasticsearch database retrieval.
...
Set rag storage variables below in `configs/dbgpt-bm25-rag.toml` file, let Datrix know how to connect to Elasticsearch.
